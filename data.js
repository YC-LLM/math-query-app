...
const MATH_QUERY_DATA = [
  { id: 1, school: '國立臺灣大學', dept: '數學系', type: '國立', region: '北部', group: '數理化學', channel: '個人申請', source: 'demo',
  ...
  { id: 6, school: '國立臺灣大學', dept: '中國文學系', type: '國立', region: '北部', group: '文史哲學', channel: '個人申請', source: 'demo',
  ...
  { id: 9, school: '國立政治大學', dept: '心理學系', type: '國立', region: '北部', group: '社會心理', channel: '個人申請', source: 'demo',
  ...
  { id: 12, school: '國立陽明交通大學', dept: '資訊工程學系', type: '國立', region: '北部', group: '資訊學群', channel: '個人申請', source: 'demo',
    mathScreen: { subject: '數學A', min: '頂標' }, mathCount: { subject: '數學A', weight: 2.0 } },
  { id: 14, school: '國立陽明交通大學', dept: '醫學系', type: '國立', region: '北部', group: '醫藥衛生', channel: '個人申請', source: 'demo',
    mathScreen: { subject: '數學A', min: '頂標' }, mathCount: { subject: '數學A', weight: 1.0 } },
  { id: 15, school: '國立清華大學', dept: '物理學系', type: '國立', region: '北部', group: '數理化學', channel: '繁星推薦', source: 'demo',
  ...
  { id: 18, school: '國立成功大學', dept: '會計學系', type: '國立', region: '南部', group: '財經學群', channel: '個人申請', source: 'demo',
    mathScreen: { subject: '數學A', min: '均標' }, mathCount: { subject: '數學A', weight: 1.0 } },
  { id: 19, school: '國立成功大學', dept: '中國文學系', type: '國立', region: '南部', group: '文史哲學', channel: '個人申請', source: 'demo',
    mathScreen: null, mathCount: null },
  ...
  { id: 22, school: '國立臺灣大學', dept: '園藝暨景觀學系', type: '國立', region: '北部', group: '生物資源', channel: '個人申請', source: 'demo',
    mathScreen: null, mathCount: { subject: '數學B', weight: 1.0 } },
  { id: 23, school: '國立中正大學', dept: '傳播學系', type: '國立', region: '南部', group: '大眾傳播', channel: '個人申請', source: 'demo',
    mathScreen: null, mathCount: null },
  { id: 24, school: '國立臺北大學', dept: '統計學系', type: '國立', region: '北部', group: '數理化學', channel: '個人申請', source: 'demo',
    mathScreen: { subject: '數學A', min: '均標' }, mathCount: { subject: '數學A', weight: 1.5 } },
  { id: 25, school: '國立臺北大學', dept: '社會工作學系', type: '國立', region: '北部', group: '社會心理', channel: '繁星推薦', source: 'demo',
    mathScreen: null, mathCount: null },
  ...
  { id: 27, school: '輔仁大學', dept: '心理學系', type: '私立', region: '北部', group: '社會心理', channel: '個人申請', source: 'demo',
    mathScreen: null, mathCount: { subject: '數學B', weight: 1.0 } },
  ...
  { id: 29, school: '逢甲大學', dept: '財務金融學系', type: '私立', region: '中部', group: '財經學群', channel: '個人申請', source: 'demo',
    mathScreen: null, mathCount: { subject: '數學B', weight: 1.0 } },
  { id: 30, school: '長庚大學', dept: '醫學系', type: '私立', region: '北部', group: '醫藥衛生', channel: '個人申請', source: 'demo',
    mathScreen: { subject: '數學A', min: '頂標' }, mathCount: { subject: '數學A', weight: 1.0 } },
  ...
  { id: 33, school: '國立高雄大學', dept: '應用數學系', type: '國立', region: '南部', group: '數理化學', channel: '個人申請', source: 'demo',
  ...
  { id: 37, school: '國立政治大學', dept: '外交學系', type: '國立', region: '北部', group: '外語學群', channel: '個人申請', source: 'demo',
    mathScreen: null, mathCount: { subject: '數學B', weight: 1.0 } },
  { id: 38, school: '國立中央大學', dept: '大氣科學系', type: '國立', region: '北部', group: '地球環境', channel: '個人申請', source: 'demo',
    mathScreen: { subject: '數學A', min: '前標' }, mathCount: { subject: '數學A', weight: 1.5 } },
];
